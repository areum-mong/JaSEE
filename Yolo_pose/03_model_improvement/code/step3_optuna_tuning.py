...
# ?®Í≥Ñ: 3?®Í≥Ñ - Î™®Îç∏ ?±Îä• Í∞úÏÑ†
# ?§Î™Ö: OptunaÎ•??¥Ïö©???ÑÍ≤©??Í≥ºÏ†Å???úÏñ¥ Î∞?ÏµúÏ†Å??
# ?ëÏÑ±?? 2026.05.13
# ================================================
import torch
...
print("\n?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ")
print("?±Îä• ÎπÑÍµê??(Strict Diff < 0.05 Í∏∞Ï?)")
print("?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ?Å‚îÅ")
comp_rows = []
for m in baseline.keys():
    comp_rows.append({'ÏßÄ??: m, 'Í∏∞Î≥∏(16Í∞?': f"{baseline[m]:.4f}", '?úÎãù??Strict)': f"{tuned[m]:.4f}", 'Î≥Ä?îÎüâ': f"{tuned[m]-baseline[m]:+.4f}"})
