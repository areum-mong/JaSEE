...
class ViewerHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        if path == "/get_image":
            ...
            if image_path:
                ...
                self.send_header("Content-type", "image/jpeg") # JPEG/PNG ì§€??
                self.end_headers()
    ...
    def translate_path(self, path):
        # viewer.html???ˆëŠ” ?”ë ‰? ë¦¬ë¥?ê¸°ì??¼ë¡œ ?œë¹™
...
if __name__ == "__main__":
    ...
    with socketserver.TCPServer(("", PORT), ViewerHandler) as httpd:
        ...
        print(f"?â”?â”?â”?â”?â”?â”?â”?â”?â”?â”?â”?â”?â”?â”")
        print(f" ì£¼ì†Œ: http://localhost:{PORT}/viewer.html")
        print(f" ë£¨íŠ¸: {ROOT_DIR}")
        print(f" ì¤‘ë‹¨?˜ë ¤ë©?Ctrl+Cë¥??„ë¥´?¸ìš”.")
