...
F1_QA = BASE_DIR / "자세히봐_RAG" / "Q&A" / "한국어 자세 피드백(Q&A쌍, TIA피드백)" / "function1_qa.json"
F1_TIA = BASE_DIR / "자세히봐_RAG" / "Q&A" / "한국어 자세 피드백(Q&A쌍, TIA피드백)" / "function1_tia_feedback_templates.json"

F2_QA = BASE_DIR / "자세히봐_RAG" / "Q&A" / "점수별 한국어 해설및 매핑" / "function2_qa.json"
F2_RULA = BASE_DIR / "자세히봐_RAG" / "Q&A" / "점수별 한국어 해설및 매핑" / "function2_rula_body_mapping.json"

F3_QA = BASE_DIR / "자세히봐_RAG" / "Q&A" / "상황별 Q&A" / "function3_qa.json"
F3_GUIDE = BASE_DIR / "자세히봐_RAG" / "Q&A" / "상황별 Q&A" / "function3_situation_guide.json"

# Guideline PDFs / DOCX
# Handle both prompt path and actual path on disk for VDT guideline
PDF_VDT_PROMPT = BASE_DIR / "자세히봐_RAG" / "기능1~3_자료" / "영상표시단말기(VDT) 취급근로자 작업관리지침(고용노동부고시)(제2020-17호).pdf"
PDF_VDT_ACTUAL = BASE_DIR / "자세히봐_RAG" / "기능1~3_자료" / "영상표시단말기(VDT) 취급근로자 작업관리지침(고용노동부고시)(제2020-17호)(20200116).pdf"
PDF_EG3 = BASE_DIR / "자세히봐_RAG" / "기능1~3_자료" / "E-G-3-2025 영상표시단말기를 사용하는 사무환경 관리에 관한 기술지원규정.pdf"
PDF_EG6 = BASE_DIR / "자세히봐_RAG" / "기능1~3_자료" / "E-G-6-2025 건강한 사무환경 구축 기술지원규정.pdf"
PDF_RULA = BASE_DIR / "자세히봐_RAG" / "기능1~3_자료" / "RULA-A-Step-by-Step-Guide1.pdf"
PDF_STAT = BASE_DIR / "자세히봐_RAG" / "기능1~3_자료" / "(통계자료_1~2차년도) 제8차 한국인 인체치수 조사 측정 결과 자료.pdf"
DOCX_POSE = BASE_DIR / "자세히봐_RAG" / "기능1~3_자료" / "fit me up_ 최종 자세기준서.docx"

# Disease and exercise databases (Functions 4 & 5)
F4_DB = BASE_DIR / "자세히봐_RAG" / "기능4_부위별 통증 완화 방법 답변" / "vdt_disease_rag_database.json"
F5_EX = BASE_DIR / "자세히봐_RAG" / "기능5_개인화 맞춤 운동 추천(자세맵핑)" / "posture_exercise_full_rag.json"
